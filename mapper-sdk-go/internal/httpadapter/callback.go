...
import (
	"encoding/json"
	"gitee.com/ascend/mapper-go-sdk/mapper-sdk-go/internal/application"
	"gitee.com/ascend/mapper-go-sdk/mapper-sdk-go/internal/common"
	"gitee.com/ascend/mapper-go-sdk/mapper-sdk-go/internal/httpadapter/requests"
	"gitee.com/ascend/mapper-go-sdk/mapper-sdk-go/internal/httpadapter/response"
	"k8s.io/klog/v2"
	"net/http"
	"net/url"
	"strings"
